...
public class BookFlight extends JFrame implements ActionListener {
    ...
    public BookFlight() {
        ...
        //for creating a drop down, we have two options:
        //use JComboBox or Choice
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            try {
                ...
                String query = "select * from passenger where cust_id = '"+custId+"'";
            ...
            try {
                ...
                String query = "select * from flight where src = '"+src+"' and destination = '"+dest+"'";
            ...
            try {
                ...
                String query = "insert into reservation values('PNR-"+random.nextInt(1000000)+"', 'TIC-"+random.nextInt(10000)+"', '"+custId+"', '"+name+"', '"+nationality+"', '"+flightname+"', '"+flightcode+"', '"+src+"', '"+des+"', '"+ddate+"')";
